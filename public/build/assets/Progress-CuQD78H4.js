import { c as createLucideIcon, d as defineComponent, o as openBlock, a as createElementBlock, l as createCommentVNode, F as Fragment, r as renderList, f as createBaseVNode, t as toDisplayString, m as computed, y as normalizeStyle, z as _export_sfc, b as createVNode, e as unref, h as head_default, v as _sfc_main$2, g as withCtx, n as normalizeClass, i as createTextVNode, K as BookOpen, k as createBlock, M as TrendingUp, _ as _sfc_main$7, x as link_default, L as progress, p as ref, P as resolveDynamicComponent } from "./app-U-Wu707C.js";
import { _ as _sfc_main$3, a as _sfc_main$4 } from "./CardContent.vue_vue_type_script_setup_true_lang-T4Xk2G9g.js";
import { _ as _sfc_main$5, a as _sfc_main$6 } from "./CardTitle.vue_vue_type_script_setup_true_lang-DjK7ckh3.js";
import { r as results } from "./index-CjDYcN3Z.js";
import { C as ChevronUp, a as ChevronDown } from "./chevron-up-CptlasEZ.js";
import { E as ExternalLink } from "./external-link-DNoZTZZq.js";
...
const _hoisted_19 = { class: "shrink-0" };
const _hoisted_20 = { class: "min-w-0 flex-1" };
const _hoisted_21 = { class: "truncate text-sm font-medium" };
const _hoisted_22 = { class: "mt-0.5 text-xs text-muted-foreground" };
const _hoisted_23 = { class: "hidden shrink-0 items-center gap-2 sm:flex" };
const _hoisted_24 = {
  key: 0,
  class: "border-t bg-muted/20 px-6 py-4"
};
const _hoisted_25 = { class: "flex flex-col gap-2" };
const _hoisted_26 = { class: "text-muted-foreground" };
const _hoisted_27 = { class: "flex items-center justify-end gap-2" };
const _hoisted_28 = { class: "h-1.5 w-16 overflow-hidden rounded-full bg-muted" };
const _hoisted_29 = { class: "text-right text-xs text-muted-foreground" };
const _hoisted_30 = { class: "flex justify-end" };
const _hoisted_31 = {
  key: 0,
  class: "mt-4"
};
          ...
          createVNode(unref(_sfc_main$4), null, {
            default: withCtx(() => [
              ...
              createVNode(unref(_sfc_main$3), { class: "px-0 pb-0" }, {
                default: withCtx(() => [
                  __props.quizHistory.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_16, [
                    createVNode(unref(BookOpen), { class: "size-8 opacity-30" }),
                    _cache[12] || (_cache[12] = createTextVNode(" No completed quiz attempts yet. ", -1))
                      ...
                      return openBlock(), createElementBlock("div", {
                        ...
                        createBaseVNode("button", {
                          ...
                          createBaseVNode("div", _hoisted_20, [
                            createBaseVNode("p", _hoisted_21, toDisplayString(item.quiz.title), 1),
                            createBaseVNode("p", _hoisted_22, toDisplayString(item.attempts_count) + " attempt" + toDisplayString(item.attempts_count === 1 ? "" : "s"), 1)
                          ]),
                          createBaseVNode("div", _hoisted_23, [
                            _cache[13] || (_cache[13] = createBaseVNode("span", { class: "text-xs text-muted-foreground" }, "Avg", -1)),
                            createBaseVNode("span", {
                            ...
                            _cache[14] || (_cache[14] = createBaseVNode("span", { class: "text-xs text-muted-foreground" }, "Best", -1)),
                            createBaseVNode("span", {
                        ...
                        expandedQuiz.value === item.quiz.id ? (openBlock(), createElementBlock("div", _hoisted_24, [
                          _cache[17] || (_cache[17] = createBaseVNode("div", { class: "mb-3 grid grid-cols-4 gap-2 text-xs font-medium uppercase tracking-wide text-muted-foreground" }, [
                          ...
                          createBaseVNode("div", _hoisted_25, [
                            (openBlock(true), createElementBlock(Fragment, null, renderList(item.history, (attempt) => {
                              return openBlock(), createElementBlock("div", {
                                ...
                                createBaseVNode("span", _hoisted_26, "# " + toDisplayString(attempt.number), 1),
                                ...
                                createBaseVNode("span", _hoisted_29, toDisplayString(toDateShort(attempt.submitted_at)), 1),
                                    ...
                                    default: withCtx(() => [
                                      createVNode(unref(link_default), {
                                        ...
                                        default: withCtx(() => [
                                          ...
                                          _cache[15] || (_cache[15] = createTextVNode(" View ", -1))
                                        ]),
                                        _: 1
                                      }, 8, ["href"])
                                    ]),
                          ...
                          item.history.length > 1 ? (openBlock(), createElementBlock("div", _hoisted_31, [
                            _cache[16] || (_cache[16] = createBaseVNode("p", { class: "mb-2 text-xs text-muted-foreground" }, "Score trend", -1)),
