import { B as onMounted, C as createCommentVNode, D as createVNode, E as createTextVNode, G as renderList, O as defineComponent, S as createBlock, St as normalizeClass, T as createStaticVNode, Tt as toDisplayString, U as openBlock, _ as Fragment, a as head_default, bt as unref, ft as ref, nt as withCtx, o as link_default, p as vShow, rt as withDirectives, w as createElementBlock, x as createBaseVNode } from "./wayfinder-BXUQpGRW.js";
import { h as register, p as login, x as _plugin_vue_export_helper_default } from "./app-DSvgGTY4.js";
//#region resources/js/pages/Welcome.vue?vue&type=script&setup=true&lang.ts
var _hoisted_1 = { class: "min-h-screen bg-gradient-to-b from-amber-50 via-white to-amber-50/30 text-gray-900 dark:from-gray-950 dark:via-gray-950 dark:to-amber-950/10 dark:text-gray-100" };
var _hoisted_2 = { class: "sticky top-0 z-50 border-b border-amber-200/50 bg-amber-50/95 backdrop-blur-md transition-all duration-300 dark:border-amber-900/30 dark:bg-gray-950/95" };
var _hoisted_3 = { class: "mx-auto flex max-w-6xl items-center justify-between px-4 py-3 md:px-6 md:py-4" };
var _hoisted_4 = { class: "hidden items-center gap-2 md:flex" };
var _hoisted_5 = {
	class: "h-6 w-6",
	fill: "none",
	viewBox: "0 0 24 24",
...
var _hoisted_8 = { class: "border-t border-amber-200/50 bg-amber-50/95 backdrop-blur-md md:hidden dark:border-amber-900/30 dark:bg-gray-950/95" };
var _hoisted_9 = { class: "flex flex-col space-y-2 px-4 py-4" };
var _hoisted_10 = { id: "main-content" };
var _hoisted_11 = { class: "relative mx-auto max-w-3xl px-4" };
var _hoisted_12 = {
	class: "animate-fade-in-up flex flex-wrap items-center justify-center gap-4",
	style: { "animation-delay": "0.2s" }
};
var _hoisted_13 = { class: "mx-auto max-w-6xl" };
var _hoisted_14 = { class: "grid gap-6 md:grid-cols-2 lg:grid-cols-3" };
var _hoisted_15 = { class: "testimonial-card rounded-2xl border border-amber-200/50 bg-white/80 p-6 shadow-sm backdrop-blur-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-xl dark:border-amber-800/30 dark:bg-gray-900/80" };
var _hoisted_16 = { class: "mb-3 flex gap-1 text-amber-400" };
var _hoisted_17 = { class: "testimonial-card rounded-2xl border border-amber-200/50 bg-white/80 p-6 shadow-sm backdrop-blur-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-xl dark:border-amber-800/30 dark:bg-gray-900/80" };
var _hoisted_18 = { class: "mb-3 flex gap-1 text-amber-400" };
var _hoisted_19 = { class: "testimonial-card rounded-2xl border border-amber-200/50 bg-white/80 p-6 shadow-sm backdrop-blur-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-xl dark:border-amber-800/30 dark:bg-gray-900/80" };
var _hoisted_20 = { class: "mb-3 flex gap-1 text-amber-400" };
var _hoisted_21 = { class: "mx-auto max-w-2xl overflow-hidden rounded-3xl bg-gradient-to-br from-amber-500 to-amber-600 p-8 text-center shadow-xl transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl md:p-12" };
var _hoisted_22 = { class: "border-t border-amber-200/50 bg-gradient-to-r from-amber-50/50 to-white/30 px-4 py-6 backdrop-blur-sm dark:border-amber-900/30 dark:from-gray-950 dark:to-gray-950/80 md:px-6 md:py-8" };
var _hoisted_23 = { class: "mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 text-sm text-gray-500 md:flex-row dark:text-gray-500" };
//#endregion
//#region resources/js/pages/Welcome.vue
var Welcome_default = /* @__PURE__ */ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	__name: "Welcome",
	props: { canRegister: {
		type: Boolean,
		default: true
	...
	setup(__props) {
			...
			const observer = new IntersectionObserver((entries) => {
				entries.forEach((entry) => {
					if (entry.isIntersecting) {
						...
						if (section) isVisible.value[section] = true;
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock(Fragment, null, [createVNode(unref(head_default), { title: "BeeSmart – Quiz Your Way to the Top" }), createBaseVNode("div", _hoisted_1, [
				...
				createBaseVNode("header", _hoisted_2, [createBaseVNode("div", _hoisted_3, [
					createVNode(unref(link_default), {
						...
						default: withCtx(() => [..._cache[4] || (_cache[4] = [createBaseVNode("svg", {
						...
						], -1), createBaseVNode("span", { class: "text-xl font-bold tracking-tight text-amber-600 transition-colors group-hover:text-amber-500 dark:text-amber-400" }, "BeeSmart", -1)])]),
						_: 1
					}),
					createBaseVNode("nav", _hoisted_4, [_ctx.$page.props.auth.user ? (openBlock(), createBlock(unref(link_default), {
						key: 0,
						href: "/dashboard",
						...
						default: withCtx(() => [..._cache[5] || (_cache[5] = [createTextVNode(" Dashboard ", -1)])]),
						_: 1
					})) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [createVNode(unref(link_default), {
						href: unref(login)(),
						...
						_: 1
					}, 8, ["href"]), __props.canRegister ? (openBlock(), createBlock(unref(link_default), {
						key: 0,
						href: unref(register)(),
						class: "rounded-full bg-amber-500 px-5 py-2 text-sm font-semibold text-white shadow-lg shadow-amber-500/20 transition-all hover:scale-105 hover:bg-amber-600 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 dark:bg-amber-500 dark:hover:bg-amber-400"
					}, {
						default: withCtx(() => [..._cache[7] || (_cache[7] = [createTextVNode(" Get Started Free ", -1)])]),
						_: 1
					}, 8, ["href"])) : createCommentVNode("", true)], 64))]),
					...
					}, [(openBlock(), createElementBlock("svg", _hoisted_5, [!mobileMenuOpen.value ? (openBlock(), createElementBlock("path", _hoisted_6)) : (openBlock(), createElementBlock("path", _hoisted_7))]))])
				]), withDirectives(createBaseVNode("div", _hoisted_8, [createBaseVNode("div", _hoisted_9, [_ctx.$page.props.auth.user ? (openBlock(), createBlock(unref(link_default), {
					key: 0,
					href: "/dashboard",
					...
					default: withCtx(() => [..._cache[8] || (_cache[8] = [createTextVNode(" Dashboard ", -1)])]),
					_: 1
				})) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [createVNode(unref(link_default), {
					href: unref(login)(),
					...
					default: withCtx(() => [..._cache[9] || (_cache[9] = [createTextVNode(" Log in ", -1)])]),
					_: 1
				}, 8, ["href"]), __props.canRegister ? (openBlock(), createBlock(unref(link_default), {
					key: 0,
					href: unref(register)(),
					...
					default: withCtx(() => [..._cache[10] || (_cache[10] = [createTextVNode(" Get Started Free ", -1)])]),
					_: 1
				}, 8, ["href"])) : createCommentVNode("", true)], 64))])], 512), [[vShow, mobileMenuOpen.value]])]),
				createBaseVNode("main", _hoisted_10, [
					createBaseVNode("section", {
						...
						createBaseVNode("div", _hoisted_12, [__props.canRegister ? (openBlock(), createBlock(unref(link_default), {
							key: 0,
							href: unref(register)(),
							...
							], -1), createTextVNode(" Start for Free ", -1)])]),
							_: 1
						}, 8, ["href"])) : createCommentVNode("", true), createVNode(unref(link_default), {
							href: unref(login)(),
							...
							default: withCtx(() => [..._cache[12] || (_cache[12] = [createTextVNode(" Log In ", -1), createBaseVNode("svg", {
					...
					createBaseVNode("section", {
						...
						default: withCtx(() => [..._cache[23] || (_cache[23] = [createTextVNode(" Create Your Free Account ", -1), createBaseVNode("svg", {
							class: "h-4 w-4 transition-transform group-hover:translate-x-1",
							viewBox: "0 0 20 20",
							fill: "currentColor"
						}, [createBaseVNode("path", {
						...
						default: withCtx(() => [..._cache[24] || (_cache[24] = [createTextVNode(" Log In to BeeSmart ", -1)])]),
						_: 1
					}, 8, ["href"]))])], 2)
				]),
				createBaseVNode("footer", _hoisted_22, [createBaseVNode("div", _hoisted_23, [
