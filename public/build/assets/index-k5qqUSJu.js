import { d as defineComponent, au as reactiveOmit, o as openBlock, k as createBlock, g as withCtx, Z as renderSlot, a0 as mergeProps, e as unref, av as cn, ai as Primitive, aG as cva, Q as queryParams, R as applyUrlDefaults } from "./app-FZe8oXsS.js";
...
const assignCategory = (args, options) => ({
  url: assignCategory.url(args, options),
  method: "patch"
});
assignCategory.definition = {
  methods: ["patch"],
  url: "/quizzes/{quiz}/assign-category"
};
assignCategory.url = (args, options) => {
  if (typeof args === "string" || typeof args === "number") {
    args = { quiz: args };
  }
  if (typeof args === "object" && !Array.isArray(args) && "id" in args) {
  ...
  return assignCategory.definition.url.replace("{quiz}", parsedArgs.quiz.toString()).replace(/\/+$/, "") + queryParams(options);
};
assignCategory.patch = (args, options) => ({
  url: assignCategory.url(args, options),
  method: "patch"
});
const assignCategoryForm = (args, options) => ({
  action: assignCategory.url(args, {
    [(options == null ? void 0 : options.mergeQuery) ? "mergeQuery" : "query"]: {
      _method: "PATCH",
      ...(options == null ? void 0 : options.query) ?? (options == null ? void 0 : options.mergeQuery) ?? {}
    }
...
assignCategoryForm.patch = (args, options) => ({
  action: assignCategory.url(args, {
    [(options == null ? void 0 : options.mergeQuery) ? "mergeQuery" : "query"]: {
      _method: "PATCH",
      ...(options == null ? void 0 : options.query) ?? (options == null ? void 0 : options.mergeQuery) ?? {}
...
assignCategory.form = assignCategoryForm;
...
({
  ...
  assignCategory: Object.assign(assignCategory, assignCategory),
