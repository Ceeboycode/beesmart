import { U as injectConfigProviderContext, p as ref, m as computed, d as defineComponent, V as toRefs, W as useVModel, X as useCollection, Y as useDirection, o as openBlock, k as createBlock, g as withCtx, Z as renderSlot, e as unref, $ as isNullish, a as createElementBlock, l as createCommentVNode, F as Fragment, r as renderList, a0 as mergeProps, a1 as PopperRoot_default, a2 as createContext, w as watch, f as createBaseVNode, a3 as VisuallyHidden_default, a4 as useForwardProps, a5 as PopperContent_default, a6 as useFocusGuards, a7 as useBodyScrollLock, a8 as useHideOthers, a9 as useTypeahead, aa as watchEffect, b as createVNode, ab as FocusScope_default, j as withModifiers, ac as DismissableLayer_default, P as resolveDynamicComponent, ad as unrefElement, ae as focusFirst, af as useForwardExpose, B as onMounted, ag as nextTick, ah as useResizeObserver, ai as Primitive, y as normalizeStyle, aj as useForwardPropsEmits, ak as normalizeProps, al as guardReactiveProps, am as Presence_default, an as Teleport, i as createTextVNode, ao as useId, ap as handleAndDispatchCustomEvent, aq as getActiveElement, C as onUnmounted, ar as Teleport_default, as as onBeforeUnmount, at as PopperAnchor_default, t as toDisplayString, c as createLucideIcon, au as reactiveOmit, av as cn, n as normalizeClass, u as useForm, D as withDirectives, E as vModelText, _ as _sfc_main$g, x as link_default, G as ChevronRight, H as router } from "./app-FZe8oXsS.js";
import { _ as _sfc_main$i } from "./ConfirmDialog.vue_vue_type_script_setup_true_lang-BrqZv0cw.js";
import { _ as _sfc_main$f } from "./InputError.vue_vue_type_script_setup_true_lang-Bvs6ypzk.js";
import { i as index, _ as _sfc_main$h } from "./index-k5qqUSJu.js";
import { a as _sfc_main$8, _ as _sfc_main$c } from "./CardContent.vue_vue_type_script_setup_true_lang-n-UlRd_e.js";
import { _ as _sfc_main$b } from "./CardDescription.vue_vue_type_script_setup_true_lang-CjOwPNj5.js";
import { _ as _sfc_main$9, a as _sfc_main$a } from "./CardTitle.vue_vue_type_script_setup_true_lang-C3Ddipjo.js";
import { _ as _sfc_main$e } from "./Input.vue_vue_type_script_setup_true_lang-CWD3gtEB.js";
import { _ as _sfc_main$d } from "./Label.vue_vue_type_script_setup_true_lang-C5pjpvK2.js";
import { i as isEqual, u as useFormControl } from "./useFormControl-B1a0qB1x.js";
import { a as ChevronDown, C as ChevronUp } from "./chevron-up-D3TikgX7.js";
import { C as Check } from "./check-DO8yqo7u.js";
import { G as GripVertical, T as Trash2, u as useToast } from "./useToast-DpKI1fLy.js";
import { E as Eye } from "./eye-CMie7mkq.js";
import { M as MonitorX, C as ChevronLeft } from "./monitor-x-Byb3IWih.js";
...
const _hoisted_49 = { class: "grid gap-1.5" };
const _hoisted_50 = ["title", "onClick"];
const _hoisted_51 = {
  key: 1,
...
const _hoisted_54 = { class: "text-xs text-muted-foreground" };
const _hoisted_55 = {
  key: 1,
  class: "grid gap-2"
};
const _hoisted_56 = { class: "flex items-center justify-between gap-2" };
const _hoisted_57 = { class: "text-xs text-muted-foreground" };
const _hoisted_58 = { class: "grid gap-2" };
const _hoisted_59 = { class: "grid gap-2" };
const _hoisted_60 = { class: "flex items-center justify-between" };
const _hoisted_61 = { class: "grid gap-4 md:grid-cols-2" };
const _hoisted_62 = { class: "space-y-1" };
const _hoisted_63 = { class: "font-semibold" };
const _hoisted_64 = { class: "space-y-1" };
const _hoisted_65 = {
  key: 0,
  class: "space-y-1 md:col-span-2"
};
const _hoisted_66 = { class: "text-sm text-muted-foreground" };
const _hoisted_67 = { class: "flex flex-wrap gap-2" };
const _hoisted_68 = { class: "grid grid-cols-2 gap-3 md:grid-cols-4" };
const _hoisted_69 = { class: "rounded-lg border bg-muted/30 p-3 text-center" };
const _hoisted_70 = { class: "text-2xl font-bold" };
const _hoisted_71 = { class: "rounded-lg border bg-muted/30 p-3 text-center" };
const _hoisted_72 = { class: "text-2xl font-bold" };
const _hoisted_73 = { class: "rounded-lg border bg-muted/30 p-3 text-center" };
const _hoisted_74 = { class: "text-2xl font-bold" };
const _hoisted_75 = { class: "rounded-lg border bg-muted/30 p-3 text-center" };
const _hoisted_76 = { class: "text-2xl font-bold" };
const _hoisted_77 = {
  key: 0,
  class: "rounded-lg border border-destructive/40 bg-destructive/5 p-4"
};
const _hoisted_78 = { class: "flex items-start gap-3" };
const _hoisted_79 = { class: "space-y-1" };
const _hoisted_80 = { class: "text-sm text-destructive/80" };
const _hoisted_81 = {
  key: 1,
  class: "rounded-lg border border-amber-200 bg-amber-50 p-4 dark:border-amber-800 dark:bg-amber-900/20"
};
const _hoisted_82 = { class: "flex items-start gap-3" };
const _hoisted_83 = {
  key: 2,
  class: "rounded-lg border border-emerald-200 bg-emerald-50 p-4 dark:border-emerald-800 dark:bg-emerald-900/20"
};
const _hoisted_84 = { class: "flex items-center gap-3" };
const _hoisted_85 = { class: "text-sm font-medium text-emerald-800 dark:text-emerald-300" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const questionsWithoutAnswers = computed(
      () => form.questions.reduce((acc, q, i) => {
        if (!q.question_text.trim()) return acc;
        const hasAnswer = q.type === "short_answer" ? q.correct_answer.some((a) => a.trim().length > 0) : q.choices.some((c) => c.is_correct);
        ...
        currentStep.value === 1 ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
              ...
              createVNode(unref(_sfc_main$c), { class: "flex flex-col gap-4" }, {
                default: withCtx(() => [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(unref(form).questions, (question, qIndex) => {
                    return openBlock(), createElementBlock("div", {
                      key: qIndex,
                      class: normalizeClass(["rounded-xl border bg-card p-4 shadow-sm", questionsWithoutAnswers.value.includes(qIndex) ? "border-destructive/50" : ""])
                    }, [
                      createBaseVNode("div", _hoisted_36, [
                        createBaseVNode("div", _hoisted_37, [
                          createVNode(unref(GripVertical), { class: "size-4" }),
                          createTextVNode(" Question " + toDisplayString(qIndex + 1) + " ", 1),
                          questionsWithoutAnswers.value.includes(qIndex) ? (openBlock(), createBlock(unref(_sfc_main$h), {
                            key: 0,
                            variant: "destructive",
                            class: "text-xs"
                          }, {
                            default: withCtx(() => [..._cache[66] || (_cache[66] = [
                              createTextVNode(" No correct answer ", -1)
                            ])]),
                            _: 1
                          })) : createCommentVNode("", true)
                        ]),
                        createVNode(unref(_sfc_main$g), {
                          ...
                          default: withCtx(() => [
                            ...
                            _cache[67] || (_cache[67] = createTextVNode(" Remove ", -1))
                          ]),
                          _: 1
                        }, 8, ["onClick"])
                      ]),
                      createBaseVNode("div", _hoisted_38, [
                        ...
                        question.type !== "short_answer" ? (openBlock(), createElementBlock("div", _hoisted_44, [
                          createBaseVNode("div", _hoisted_45, [
                            createVNode(unref(_sfc_main$d), null, {
                              default: withCtx(() => [..._cache[74] || (_cache[74] = [
                                createTextVNode("Answer choices", -1)
                              ])]),
                              _: 1
                            }),
                            question.type === "multiple_choice" ? (openBlock(), createElementBlock("span", _hoisted_46, toDisplayString(question.choices.filter((c) => c.choice_text.trim()).length) + " / " + toDisplayString(question.choices.length) + " filled ", 1)) : createCommentVNode("", true)
                          ]),
                          question.type === "multiple_choice" ? (openBlock(), createElementBlock("p", _hoisted_47, " Click the circle to mark a choice as correct. Need at least 1 correct and 1 wrong. Blank choices are ignored when saving. ")) : (openBlock(), createElementBlock("p", _hoisted_48, " Select which answer is correct. ")),
                          createBaseVNode("div", _hoisted_49, [
                            (openBlock(true), createElementBlock(Fragment, null, renderList(question.choices, (choice, cIndex) => {
                              return openBlock(), createElementBlock("div", {
                                key: cIndex,
                                class: normalizeClass(["flex items-center gap-2 rounded-lg border bg-background px-3 py-2 transition-colors", choice.is_correct ? "border-emerald-400 bg-emerald-50/50 dark:border-emerald-700 dark:bg-emerald-950/30" : "border-border"])
                              }, [
                                createBaseVNode("button", {
                                  type: "button",
                                  class: normalizeClass(["flex size-7 shrink-0 items-center justify-center rounded-full border-2 transition-all", choice.is_correct ? "border-emerald-500 bg-emerald-500 text-white" : "border-muted-foreground/30 text-muted-foreground hover:border-emerald-400 hover:text-emerald-500"]),
                                  ...
                                  choice.is_correct ? (openBlock(), createBlock(unref(CircleCheck), {
                                    key: 0,
                                    class: "size-3.5"
                                  })) : (openBlock(), createElementBlock("span", _hoisted_51, toDisplayString(String.fromCharCode(65 + cIndex)), 1))
                                ], 10, _hoisted_50),
                                createVNode(unref(_sfc_main$e), {
                                  ...
                                  class: normalizeClass(["flex-1 border-0 bg-transparent px-0 shadow-none focus-visible:ring-0", choice.is_correct ? "font-medium text-emerald-700 dark:text-emerald-400" : ""])
                                }, null, 8, ["modelValue", "onUpdate:modelValue", "placeholder", "readonly", "class"]),
                                choice.is_correct ? (openBlock(), createElementBlock("span", _hoisted_52, "Correct")) : createCommentVNode("", true),
                          ...
                          question.type === "multiple_choice" ? (openBlock(), createElementBlock("div", _hoisted_53, [
                            createVNode(unref(_sfc_main$g), {
                              type: "button",
                              variant: "outline",
                              size: "sm",
                              ...
                              default: withCtx(() => [
                                ...
                                _cache[75] || (_cache[75] = createTextVNode(" Add choice ", -1))
                              ]),
                              _: 1
                            }, 8, ["onClick"]),
                            createBaseVNode("span", _hoisted_54, toDisplayString(question.choices.length) + " choices total", 1)
                          ])) : createCommentVNode("", true),
                          createVNode(_sfc_main$f, {
                            message: questionError(qIndex, "choices")
                          }, null, 8, ["message"])
                          ...
                          createBaseVNode("p", _hoisted_57, toDisplayString(question.case_sensitive ? "Exact case match required." : "Case-insensitive — any capitalisation accepted.") + " Add every wording you want to accept. ", 1),
                          ...
                          createVNode(unref(_sfc_main$g), {
                            ...
                            default: withCtx(() => [
                              createVNode(unref(Plus), { class: "size-4" }),
                              _cache[77] || (_cache[77] = createTextVNode(" Add accepted answer ", -1))
                            ]),
                            _: 1
                          }, 8, ["onClick"]),
                          createVNode(_sfc_main$f, {
                            message: questionError(qIndex, "correct_answer")
                          }, null, 8, ["message"])
                        ])),
                  ...
                  createVNode(unref(_sfc_main$g), {
                    ...
                    default: withCtx(() => [
                      createVNode(unref(Plus), { class: "size-4" }),
                      _cache[79] || (_cache[79] = createTextVNode(" Add question ", -1))
                    ]),
                    _: 1
                  })
                ]),
          ...
          createBaseVNode("div", _hoisted_60, [
            createVNode(unref(_sfc_main$g), {
              ...
              default: withCtx(() => [
                ...
                _cache[80] || (_cache[80] = createTextVNode(" Back ", -1))
              ]),
              _: 1
            }),
            createVNode(unref(_sfc_main$g), { onClick: nextStep }, {
              default: withCtx(() => [
                _cache[81] || (_cache[81] = createTextVNode(" Review ", -1)),
                createVNode(unref(ChevronRight), { class: "size-4" })
              ]),
              _: 1
            })
                ...
                default: withCtx(() => [
                  createBaseVNode("div", _hoisted_61, [
                    createBaseVNode("div", _hoisted_62, [
                      _cache[83] || (_cache[83] = createBaseVNode("p", { class: "text-xs font-semibold tracking-wide text-muted-foreground uppercase" }, " Title ", -1)),
                      createBaseVNode("p", _hoisted_63, toDisplayString(unref(form).title || "—"), 1)
                    ]),
                    createBaseVNode("div", _hoisted_64, [
                      _cache[84] || (_cache[84] = createBaseVNode("p", { class: "text-xs font-semibold tracking-wide text-muted-foreground uppercase" }, " Status ", -1)),
                    ...
                    unref(form).description ? (openBlock(), createElementBlock("div", _hoisted_65, [
                      _cache[85] || (_cache[85] = createBaseVNode("p", { class: "text-xs font-semibold tracking-wide text-muted-foreground uppercase" }, " Description ", -1)),
                      createBaseVNode("p", _hoisted_66, toDisplayString(unref(form).description), 1)
                    ])) : createCommentVNode("", true)
                  ]),
                  _cache[93] || (_cache[93] = createBaseVNode("div", { class: "h-px bg-border" }, null, -1)),
                  createBaseVNode("div", _hoisted_67, [
                    ...
                    createBaseVNode("div", {
                      ...
                      _cache[86] || (_cache[86] = createTextVNode(" Tab monitoring: ", -1)),
                  ...
                  _cache[94] || (_cache[94] = createBaseVNode("div", { class: "h-px bg-border" }, null, -1)),
                  createBaseVNode("div", _hoisted_68, [
                    createBaseVNode("div", _hoisted_69, [
                      createBaseVNode("p", _hoisted_70, toDisplayString(unref(form).questions.length), 1),
                      _cache[87] || (_cache[87] = createBaseVNode("p", { class: "mt-0.5 text-xs text-muted-foreground" }, " Total slots ", -1))
                    ]),
                    createBaseVNode("div", _hoisted_71, [
                      createBaseVNode("p", _hoisted_72, toDisplayString(questionsFilledIn.value), 1),
                      _cache[88] || (_cache[88] = createBaseVNode("p", { class: "mt-0.5 text-xs text-muted-foreground" }, " Filled in ", -1))
                    ]),
                    createBaseVNode("div", _hoisted_73, [
                      createBaseVNode("p", _hoisted_74, toDisplayString(totalPoints.value), 1),
                      _cache[89] || (_cache[89] = createBaseVNode("p", { class: "mt-0.5 text-xs text-muted-foreground" }, " Total points ", -1))
                    ]),
                    createBaseVNode("div", _hoisted_75, [
                      createBaseVNode("p", _hoisted_76, toDisplayString(unref(form).max_attempts ?? "∞"), 1),
                      _cache[90] || (_cache[90] = createBaseVNode("p", { class: "mt-0.5 text-xs text-muted-foreground" }, " Max attempts ", -1))
                    ])
                  ]),
                  cannotProceed.value ? (openBlock(), createElementBlock("div", _hoisted_77, [
                    createBaseVNode("div", _hoisted_78, [
                      createVNode(unref(TriangleAlert), { class: "mt-0.5 size-4 shrink-0 text-destructive" }),
                      createBaseVNode("div", _hoisted_79, [
                        _cache[91] || (_cache[91] = createBaseVNode("p", { class: "text-sm font-medium text-destructive" }, " Cannot save — correct answers missing ", -1)),
                        createBaseVNode("p", _hoisted_80, " Question" + toDisplayString(questionsWithoutAnswers.value.length === 1 ? "" : "s") + " " + toDisplayString(questionsWithoutAnswers.value.map((i) => i + 1).join(", ")) + " " + toDisplayString(questionsWithoutAnswers.value.length === 1 ? "is" : "are") + " missing a correct answer. Go back and mark the correct answer for each. ", 1)
                      ])
                    ])
                  ])) : questionsFilledIn.value === 0 ? (openBlock(), createElementBlock("div", _hoisted_81, [
                    createBaseVNode("div", _hoisted_82, [
                      createVNode(unref(TriangleAlert), { class: "mt-0.5 size-4 shrink-0 text-amber-600 dark:text-amber-400" }),
                      _cache[92] || (_cache[92] = createBaseVNode("div", { class: "space-y-1" }, [
                        createBaseVNode("p", { class: "text-sm font-medium text-amber-800 dark:text-amber-300" }, " No questions filled in yet "),
                        createBaseVNode("p", { class: "text-sm text-amber-700 dark:text-amber-400" }, " Go back and add at least one question before saving. ")
                      ], -1))
                    ])
                    ...
                    createBaseVNode("div", _hoisted_84, [
                      ...
                      createBaseVNode("p", _hoisted_85, " All " + toDisplayString(questionsFilledIn.value) + " question" + toDisplayString(questionsFilledIn.value === 1 ? "" : "s") + " are ready. ", 1)
                    ])
                  ]))
                ]),
                _: 1
          ...
          createBaseVNode("div", _hoisted_86, [
            createVNode(unref(_sfc_main$g), {
              ...
              default: withCtx(() => [
                createVNode(unref(ChevronLeft), { class: "size-4" }),
                _cache[95] || (_cache[95] = createTextVNode(" Back to questions ", -1))
              ]),
              _: 1
            }),
            createVNode(unref(_sfc_main$g), {
              disabled: unref(form).processing || cannotProceed.value,
              onClick: requestSave
            }, {
              default: withCtx(() => [
