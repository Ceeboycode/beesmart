import { $ as watch, A as guardReactiveProps, B as onMounted, C as createCommentVNode, Ct as normalizeProps, E as createTextVNode, I as mergeModels, K as renderSlot, L as mergeProps, N as inject, O as defineComponent, S as createBlock, St as normalizeClass, Tt as toDisplayString, U as openBlock, V as onUnmounted, W as provide, Z as useModel, _ as Fragment, b as computed, bt as unref, et as watchEffect, ft as ref, j as h, mt as shallowRef, nt as withCtx, w as createElementBlock, wt as normalizeStyle, x as createBaseVNode } from "./wayfinder-BXUQpGRW.js";
import { A as useEventListener, D as defaultDocument, N as reactiveOmit, O as defaultWindow, ct as useForwardProps, j as usePrevious, st as useForwardPropsEmits, xt as cn } from "./app-DSvgGTY4.js";
...
var InputOTP_default = /* @__PURE__ */ defineComponent({
	__name: "InputOTP",
	props: {
		maxlength: {},
		textAlign: {},
...
var InputOTPGroup_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", mergeProps({ "data-slot": "input-otp-group" }, unref(forwarded), { class: unref(cn)("flex items-center", props.class) }), [renderSlot(_ctx.$slots, "default")], 16);
		};
	}
});
//#endregion
...
var InputOTPSlot_default = /* @__PURE__ */ defineComponent({
	__name: "InputOTPSlot",
	props: {
		index: {},
		class: { type: [
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			}), [createTextVNode(toDisplayString(slot.value?.char) + " ", 1), slot.value?.hasFakeCaret ? (openBlock(), createElementBlock("div", _hoisted_2, [..._cache[0] || (_cache[0] = [createBaseVNode("div", { class: "animate-caret-blink bg-foreground h-4 w-px duration-1000" }, null, -1)])])) : createCommentVNode("", true)], 16, _hoisted_1);
		};
	}
});
//#endregion
export { InputOTPGroup_default as n, InputOTP_default as r, InputOTPSlot_default as t };
