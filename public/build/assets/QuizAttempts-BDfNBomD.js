...
import { E as createLucideIcon, S as Button_default, r as Heading_default } from "./app-DSvgGTY4.js";
...
import { n as results } from "./attempts-qxJSMs8x.js";
...
//#endregion
//#region resources/js/pages/Attempt/QuizAttempts.vue?vue&type=script&setup=true&lang.ts
...
var _hoisted_4 = { class: "grid grid-cols-2 gap-4 sm:grid-cols-4" };
...
var _hoisted_10 = { class: "min-w-0" };
var _hoisted_11 = { class: "truncate text-sm font-medium" };
var _hoisted_12 = {
	key: 0,
	class: "text-xs text-muted-foreground"
};
var _hoisted_13 = { class: "text-xs text-muted-foreground" };
var _hoisted_14 = { class: "flex items-center gap-4" };
var _hoisted_15 = { class: "hidden flex-col items-end gap-1 sm:flex" };
var _hoisted_16 = { class: "text-xs text-muted-foreground" };
var _hoisted_17 = { class: "h-1.5 w-24 overflow-hidden rounded-full bg-muted" };
var _hoisted_18 = {
	key: 2,
	class: "rounded-xl border border-dashed p-10 text-center text-sm text-muted-foreground"
};
//#endregion
//#region resources/js/pages/Attempt/QuizAttempts.vue
var QuizAttempts_default = /* @__PURE__ */ defineComponent({
	__name: "QuizAttempts",
	props: {
		quiz: {},
		attempts: {},
	...
	setup(__props) {
		...
		const mySubmittedCount = computed(() => props.isOwner ? 0 : submitted.value.length);
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock(Fragment, null, [createVNode(unref(head_default), { title: `Attempts — ${props.quiz.title}` }, null, 8, ["title"]), createBaseVNode("div", _hoisted_1, [
				...
				}, null, 8, ["title", "description"]), createBaseVNode("div", _hoisted_3, [createVNode(unref(Badge_default), {
					variant: "outline",
					class: "font-mono tracking-widest"
				}, {
					default: withCtx(() => [createTextVNode(toDisplayString(props.quiz.quiz_code), 1)]),
					_: 1
				...
				createBaseVNode("div", _hoisted_4, [
					createVNode(unref(Card_default), { class: "text-center" }, {
						default: withCtx(() => [createVNode(unref(CardHeader_default), { class: "pb-1 pt-4" }, {
							default: withCtx(() => [createVNode(unref(CardDescription_default), { class: "text-xs" }, {
								default: withCtx(() => [..._cache[1] || (_cache[1] = [createTextVNode("Total attempts", -1)])]),
								_: 1
							})]),
							_: 1
						}), createVNode(unref(CardContent_default), { class: "pb-4 text-3xl font-bold" }, {
							default: withCtx(() => [createTextVNode(toDisplayString(props.attempts.length), 1)]),
							_: 1
						})]),
						_: 1
					}),
					createVNode(unref(Card_default), { class: "text-center" }, {
						default: withCtx(() => [createVNode(unref(CardHeader_default), { class: "pb-1 pt-4" }, {
							default: withCtx(() => [createVNode(unref(CardDescription_default), { class: "text-xs" }, {
								default: withCtx(() => [..._cache[2] || (_cache[2] = [createTextVNode("Submitted", -1)])]),
								_: 1
							})]),
							_: 1
						}), createVNode(unref(CardContent_default), { class: "pb-4 text-3xl font-bold" }, {
							default: withCtx(() => [createTextVNode(toDisplayString(submitted.value.length), 1)]),
							_: 1
						})]),
						_: 1
					}),
					createVNode(unref(Card_default), { class: "text-center" }, {
						default: withCtx(() => [createVNode(unref(CardHeader_default), { class: "pb-1 pt-4" }, {
							default: withCtx(() => [createVNode(unref(CardDescription_default), { class: "text-xs" }, {
								default: withCtx(() => [..._cache[3] || (_cache[3] = [createTextVNode("Max score", -1)])]),
								_: 1
							})]),
							_: 1
						}), createVNode(unref(CardContent_default), { class: "pb-4 text-3xl font-bold" }, {
							default: withCtx(() => [createTextVNode(toDisplayString(props.maxScore), 1)]),
							_: 1
						})]),
						_: 1
					}),
					createVNode(unref(Card_default), { class: "text-center" }, {
						default: withCtx(() => [createVNode(unref(CardHeader_default), { class: "pb-1 pt-4" }, {
							default: withCtx(() => [createVNode(unref(CardDescription_default), { class: "text-xs" }, {
								default: withCtx(() => [createTextVNode(toDisplayString(props.isOwner ? "Avg score" : "Best score"), 1)]),
								_: 1
							})]),
							_: 1
						}), createVNode(unref(CardContent_default), { class: "pb-4 text-3xl font-bold" }, {
							default: withCtx(() => [props.isOwner && submitted.value.length ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [createTextVNode(toDisplayString(Math.round(submitted.value.reduce((s, a) => s + (a.total_score ?? 0), 0) / submitted.value.length)), 1)], 64)) : !props.isOwner && bestScore.value !== null ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [createTextVNode(toDisplayString(bestScore.value), 1)], 64)) : (openBlock(), createElementBlock(Fragment, { key: 2 }, [createTextVNode("—")], 64))]),
							_: 1
						})]),
						_: 1
					})
				...
				}, [createVNode(unref(Lock), { class: "size-4 shrink-0" }), attemptsRemaining.value === 0 ? (openBlock(), createElementBlock("span", _hoisted_5, [
				...
				inProgress.value.length > 0 ? (openBlock(), createBlock(unref(Card_default), { key: 1 }, {
					default: withCtx(() => [createVNode(unref(CardHeader_default), null, {
						default: withCtx(() => [createVNode(unref(CardTitle_default), { class: "flex items-center gap-2 text-sm font-semibold" }, {
							default: withCtx(() => [createVNode(unref(Clock), { class: "size-4 text-amber-500" }), createTextVNode(" In progress (" + toDisplayString(inProgress.value.length) + ") ", 1)]),
							_: 1
						})]),
						_: 1
					}), createVNode(unref(CardContent_default), { class: "flex flex-col divide-y" }, {
						default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(inProgress.value, (attempt) => {
							return openBlock(), createElementBlock("div", {
								...
								default: withCtx(() => [..._cache[6] || (_cache[6] = [createTextVNode("In progress", -1)])]),
								_: 1
							})]);
						}), 128))]),
						_: 1
				...
				createVNode(unref(Card_default), null, {
					default: withCtx(() => [createVNode(unref(CardHeader_default), null, {
						default: withCtx(() => [createVNode(unref(CardTitle_default), { class: "flex items-center gap-2 text-sm font-semibold" }, {
							default: withCtx(() => [createVNode(unref(CircleCheck), { class: "size-4 text-emerald-500" }), createTextVNode(" Submitted (" + toDisplayString(submitted.value.length) + ") ", 1)]),
							_: 1
						}), submitted.value.length === 0 ? (openBlock(), createBlock(unref(CardDescription_default), { key: 0 }, {
							default: withCtx(() => [..._cache[7] || (_cache[7] = [createTextVNode("No submitted attempts yet.", -1)])]),
							_: 1
						})) : createCommentVNode("", true)]),
						_: 1
					}), submitted.value.length > 0 ? (openBlock(), createBlock(unref(CardContent_default), {
						key: 0,
						class: "flex flex-col divide-y p-0"
					}, {
						default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(submitted.value, (attempt) => {
							return openBlock(), createElementBlock("div", {
								key: attempt.id,
								...
								createBaseVNode("div", _hoisted_15, [createBaseVNode("span", _hoisted_16, toDisplayString(attempt.total_score ?? 0) + " / " + toDisplayString(props.maxScore), 1), createBaseVNode("div", _hoisted_17, [createBaseVNode("div", {
								...
								createVNode(unref(Badge_default), {
									...
									default: withCtx(() => [createTextVNode(toDisplayString(scorePercent(attempt.total_score)) + "% ", 1)]),
									_: 2
								}, 1032, ["variant"]),
								createVNode(unref(Button_default), {
									size: "sm",
									...
									default: withCtx(() => [createVNode(unref(link_default), { href: unref(results)(attempt.id).url }, {
										default: withCtx(() => [createVNode(unref(ExternalLink), { class: "size-3.5" }), _cache[8] || (_cache[8] = createTextVNode(" Results ", -1))]),
										_: 1
									}, 8, ["href"])]),
									_: 2
								}, 1024)
...
//#endregion
export { QuizAttempts_default as default };
