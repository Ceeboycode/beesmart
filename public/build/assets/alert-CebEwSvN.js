...
import { St as cva, xt as cn } from "./app-DSvgGTY4.js";
//#endregion
...
var alertVariants = cva("relative w-full rounded-2xl border px-4 py-3 text-sm grid has-[>svg]:grid-cols-[calc(var(--spacing)*4)_1fr] grid-cols-[0_1fr] has-[>svg]:gap-x-3 gap-y-0.5 items-start [&>svg]:size-4 [&>svg]:translate-y-0.5 [&>svg]:text-current", {
	variants: { variant: {
...
//#endregion
export { AlertDescription_default as n, Alert_default as r, AlertTitle_default as t };
